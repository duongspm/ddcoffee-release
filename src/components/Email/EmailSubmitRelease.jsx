                ...
                <div class="flex items-end mb-3">
                    <div class="relative w-full mr-3 revue-form-group">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                            ...
                            <input value={email} onChange={(e) => setEmail(e.target.value)} class="revue-form-field bg-gray-50 border border-gray-300 rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full pl-20 pr-20 p-2.5  dark:focus:ring-blue-500  mt-1 text-sm text-gray-500" placeholder="Địa chỉ email của bạn..." type="email" name="member[email]" id="member_email" required="" />
                        </div>
